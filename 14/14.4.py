...
# 1 ==========================================================================
'''Задача 1. Настройка
Вы устроились Python-разработчиком, и на новом рабочем месте уже стоит PyCharm. Конечно же,
прежде чем начать работать с кодом, вы хотите настроить его под себя, чтобы чувствовать себя
как дома.
...
Найдите раздел, который отвечает за стиль кода в Python, и сравните с тем, что мы писали
раньше.'''
# 2 ==========================================================================
'''Задача 2. НОД
...
gcd(30, 18)
Теперь представьте ситуацию, что вам нужно объяснить другому человеку, как этот код 
работает, шаг за шагом. Предположим, на вход подаются числа 4782 и 698. Используя только 
точку останова, определите, чему будет равняться переменная а, когда переменная b станет 
равна двум.
'''
# def gcd(a, b):
#     while a != 0 and b != 0:
...
# 3 ==========================================================================
'''Задача 3. Сессия
Для сдачи зачёта студент Пётр написал программу, которая по координатам двух точек определяет 
уравнение прямой, проходящей через эти две точки, в виде y = k * x + b, где k и b—числа, 
